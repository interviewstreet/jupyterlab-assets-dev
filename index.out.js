...
export async function main() {
  ...
  if (!queuedFederated.includes('@hackerrank/copy-paste-tracker-extension')) {
    try {
      let ext = require('@hackerrank/copy-paste-tracker-extension');
      for (let plugin of activePlugins(ext)) {
  ...
  if (!queuedFederated.includes('@hackerrank/hackerrank-iframe-com-extension')) {
    try {
      let ext = require('@hackerrank/hackerrank-iframe-com-extension');
      for (let plugin of activePlugins(ext)) {
        register.push(plugin);
      }
    } catch (e) {
